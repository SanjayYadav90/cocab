...
/* @var $searchModel backend\models\TrackHistorySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Track History';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="track-history-index">
		...
		'toolbar' => [
						['content'=>
							Html::a('<i class="glyphicon glyphicon-plus"></i> ',['create'], ['type'=>'button',
								'title'=>'Add New track history of delivery boy ', 'class'=>'btn btn-success']) . Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['index'], ['data-pjax'=>false, 'class' => 'btn btn-default', 'title'=>'Reset Grid'])
						],
						'{export}',
						'{toggleData}'
					],
		 'panel' => [
						'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-road"></i> Tracking History of Delivery Boy </h3>',
						'type'=>'primary',
						'after'=>Html::a(''),
						'showFooter'=>false
					],	
            ...
            /*  [
             ...
             [	
					...
					'urlCreator' => function ($action, $model, $key, $index) {
								...
								if ($action === 'view') {
									$url = Yii::$app->urlManager->createUrl(['/track-history/view',"id" => $model->id,]);
									return $url;
								}
								if ($action === 'update') {
									$url = Yii::$app->urlManager->createUrl(['/track-history/update',"id" => $model->id,]); 
									return $url;
								}
